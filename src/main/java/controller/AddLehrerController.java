...
public class AddLehrerController {
    ...
    private void addLehrer() {
        try {
            ...
            alert.setTitle("Lehrer hinzufügen");
            alert.setHeaderText("Lehrer hinzufügen");
            alert.setContentText("Der Lehrer wurde hinzugefügt, sie werden zum Menü zurück geleitet");
            alert.showAndWait();
